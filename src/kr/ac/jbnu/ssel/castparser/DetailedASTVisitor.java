...
public class DetailedASTVisitor extends ASTVisitor {
	...
	protected void extractPreprocessorNodes() {
		...
		if (statements != null && statements.length != 0) {
			for (IASTPreprocessorStatement pstatement : statements) {
				...
				} else if (pstatement instanceof IASTPreprocessorPragmaStatement) {
					visit((IASTPreprocessorPragmaStatement) pstatement);
				}
			}
		}
	}
	...
	protected int visit(IASTPreprocessorPragmaStatement statement) {
		return ASTVisitor.PROCESS_CONTINUE;
	}
